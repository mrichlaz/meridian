...
Management: minClaimAmount, outOfRangeBinsToClose, outOfRangeWaitMinutes, belowRangeExitMinutes, maxHoldMinutes, conversionExitPct, conversionExitPnlPct, oorCooldownTriggerCount, oorCooldownHours, repeatDeployCooldownEnabled, repeatDeployCooldownTriggerCount, repeatDeployCooldownHours, repeatDeployCooldownScope, repeatDeployCooldownMinFeeEarnedPct, maxDeploysPerToken24h (max deploys into the same token per rolling 24h, 0=off), minVolumeToRebalance, stopLossPct, takeProfitPct, minSolToOpen, deployAmountSol, gasReserve, positionSizePct, minFeePerTvl24h, minAgeBeforeYieldCheck, trailingTakeProfit, trailingTriggerPct, trailingDropPct, trailingRetracePct, pnlSanityMaxDiffPct, solMode, autoSwapAfterClaim, evolveEnabled, thresholdEvolveEnabled
