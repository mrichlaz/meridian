...
Management: minClaimAmount, outOfRangeBinsToClose, outOfRangeWaitMinutes, belowRangeExitMinutes, oorCooldownTriggerCount, oorCooldownHours, repeatDeployCooldownEnabled, repeatDeployCooldownTriggerCount, repeatDeployCooldownHours, repeatDeployCooldownScope, repeatDeployCooldownMinFeeEarnedPct, minVolumeToRebalance, stopLossPct, takeProfitPct, minSolToOpen, deployAmountSol, gasReserve, positionSizePct, minFeePerTvl24h, minAgeBeforeYieldCheck, trailingTakeProfit, trailingTriggerPct, trailingDropPct, trailingRetracePct, pnlSanityMaxDiffPct, solMode, autoSwapAfterClaim, evolveEnabled, thresholdEvolveEnabled
  (trailing TP is a ratchet: exits when PnL drops from peak by max(trailingDropPct, peak × trailingRetracePct). belowRangeExitMinutes closes a position whose whole range is above the price — fully converted inventory.)
